...
LEXICON: dict[str: dict[str: str|list]] = {
    ...
    'correct_new_gift_idea': {
        'ru': 'Окей, в какую группу добавляем?',
        'eng': ['', '']
    },
    'user_already_has_gift': {
        'ru': ['У вас уже есть подарок с названием ', '👉👈\nПопробуйте придумать что-то еще...'],
        'eng': ''
    },
    ...
    'fill_group_for_delete_idea': {
        'ru': 'Из какой группы вы хотите удалить подарок?\n'
              '*Если вы удалите его из общедоступных подарков, то он будет автоматически удален из всех ваших групп.',
        'eng': ''
    },
    'fill_delete_idea': {
        'ru': 'Выберите из списка подарок для удаления.',
        'eng': ''
    },
    'fill_group_name': {
